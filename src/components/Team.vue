<template>
  <div class="team">
    ...
    <div class="players">
      <v-tabs v-model="tab" color="light-green lighten-1">
        <v-tabs-slider></v-tabs-slider>
        <v-tab href="#datos">Datos</v-tab>
        <v-tab href="#pretemporada">Pretemporada</v-tab>
        <v-tab href="#totales-19-20">Totales 19/20</v-tab>
        <v-tab href="#promedios-19-20">Por partido</v-tab>
        <v-tab href="#40-min-19-20">Por 40 min.</v-tab>
        <v-tab href="#avanzadas-19-20">Avanzadas tiro</v-tab>
      </v-tabs>
      <v-tabs-items v-model="tab">
        ...
        <v-tab-item value="pretemporada">
          <Matches :matches="matches" :team="team.id"/>
        </v-tab-item>
        <v-tab-item value="totales-19-20">
          <v-simple-table dense>
            <template v-slot:default>
              <thead>
                <tr>
                  <th class="td-pos">Pos.</th>
                  <th class="text-left td-name">Jugador</th>
                  <th class="text-left td-team">Equipo</th>
        ...
        <v-tab-item value="promedios-19-20">
          <v-simple-table dense>
            <template v-slot:default>
              <thead>
                <tr>
        ...
        <v-tab-item value="avanzadas-19-20">
          <v-simple-table dense>
            <template v-slot:default>
              <thead>
                <tr>
